...
```console
helm install argo-workflows-templates oci://ghcr.io/younsl/charts/argo-workflows-templates --version 0.3.0
```
...
```console
helm pull oci://ghcr.io/younsl/charts/argo-workflows-templates --untar --version 0.3.0
